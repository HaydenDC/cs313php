...
function loadLogIn() {
  ...
  xhttp.open("GET", "https://morning-basin-25235.herokuapp.com/dragonsLogIn.php", true);
  xhttp.send();
}
...
function loadAlumni() {
  ...
  xhttp.open("GET", "https://morning-basin-25235.herokuapp.com/dragonsAlumni.php", true);
  xhttp.send();
}
