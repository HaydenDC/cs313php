    ...
    <body>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
            ...
            <select name="books">
                ...
                $query = $db->query('SELECT * FROM scripture ORDER BY id DESC')->fetchAll();
                ...
                foreach($db->query('SELECT DISTINCT book FROM scripture')->fetchAll() as $books){
        ...
        <?php
            ...
            foreach($query as $row){
                    ...
                    foreach($db->query("SELECT * FROM topics t JOIN scripTopicLink tc ON topic.id = tc.tid WHERE sid='" . $row['id'] . "'") as $topic){
